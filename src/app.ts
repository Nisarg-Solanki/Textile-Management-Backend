...
import beamQualitiesRouter from "./routes/beamQualities";
import productionQualitiesRouter from "./routes/productionQualities";
...
app.use("/api/v1/beam-qualities", beamQualitiesRouter);
app.use("/api/v1/production-qualities", productionQualitiesRouter);
